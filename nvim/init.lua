...
-- does not work in some terminal emulators but I still map it.
...
-- make x delete into the black hole register
...
vim.keymap.set('t', '<Esc>', '<C-\\><C-n>', { desc = '[Esc]ape Terminal to return to Normal Mode' })
